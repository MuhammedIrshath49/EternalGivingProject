...
RESOURCES_DATA = {
    ...
    "Surahs": [
        {"title": "Surah Yaseen", "url": "https://example.com/yaseen", "type": "PDF"},
        {"title": "Surah Mulk", "url": "https://example.com/mulk", "type": "PDF"}
    ],
    "Iqra": [
        {"title": "Iqra Book 1", "url": "https://example.com/iqra1", "type": "PDF"}
    ],
    "Latest Articles": [
        {"title": "Article 1", "url": "https://example.com/article1", "type": "PDF"}
    ],
    "Awrad": [
        {"title": "Awrad Zuhooriyah", "url": "https://tinyurl.com/awradzuhooriyah", "type": "PDF"}
    ],
    "Handbooks": [
